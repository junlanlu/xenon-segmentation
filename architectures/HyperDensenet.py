...
class HyperDenseNet(BaseModel):
    def __init__(self, in_channels=3, classes=4):
        ...
        assert (
            in_channels == 3
        ), "HyperDensenet supports 3 in_channels. For 2 in_channels use HyperDenseNet_2Mod "
        self.num_classes = classes
    ...
    def forward(self, input):
        ...
        inputFully = torch.cat(
            (outputPath_top, outputPath_middle, outputPath_bottom), dim=1
        )
