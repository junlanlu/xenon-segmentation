...
Source: https://arxiv.org/abs/2103.10504
"""
import logging
import pdb
...
class UNETR(BaseModel):
    def __init__(
        ...
        Args:
            ...
            qkv_bias: apply the bias term for the qkv linear layer in self attention
                block
        """
    ...
    def test(self, device="cpu"):
        ...
        ideal_out = torch.rand(1, 2, 128, 128, 128)
        out = self.forward(input_tensor)

        assert ideal_out.shape == out.shape
        logging.info("UNetR is complete")
