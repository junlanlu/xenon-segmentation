...
from lib.losses.BCE_dice import BCEDiceLoss
from lib.losses.ContrastiveLoss import ContrastiveLoss
from lib.losses.dice import DiceLoss
from lib.losses.generalized_dice import GeneralizedDiceLoss

# not working yet - todo
from lib.losses.pixel_wise_cross_entropy import PixelWiseCrossEntropyLoss
from lib.losses.tags_angular_loss import TagsAngularLoss
from lib.losses.weight_cross_entropy import WeightedCrossEntropyLoss
from lib.losses.weight_smooth_l1 import WeightedSmoothL1Loss
...
class TestCriterion:
    ...
    def test_PixelWiseCrossEntropyLoss(self):
        ...
        weights_in_forward_call = torch.rand(
            self.batch, self.dim, self.dim, self.dim
        ).long()
