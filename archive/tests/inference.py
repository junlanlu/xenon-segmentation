...
def main():
    ...
    (
        ...
        full_volume,
        affine,
    ) = medical_loaders.generate_datasets(args, path="./datasets")
...
def get_arguments():
    ...
    parser.add_argument(
        "--lr", default=1e-2, type=float, help="learning rate (default: 1e-3)"
    )
    ...
    args.save = (
        ...
        + "_checkpoints/"
        + args.model
        + "_{}_{}_".format(utils.datestr(), args.dataset_name)
    )
